...
data_base_path = os.path.abspath('../../../experiment/pre-compaction')
...
#             f.close()
#
#         should_compact = meta.get('config', 'should_compact')
#         for rw in rws:
#             output_path = '%s/timeseries-compact-%s-%s-%s-%s.png' % (output_dir_path, should_compact, rw, workload_type, dir_name)
#
