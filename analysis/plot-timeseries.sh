...
set label 4 at graph (10000.0 / (${CATCHUP_MORPHUS_TASK} + 20000)), 0.80 tc lt 3
set label 2 "Atomic Swap" rotate by -90
set label 2 at graph ((10000.0 + ${INSERT_MORPHUS_TASK}) / (${CATCHUP_MORPHUS_TASK} + 20000)), 0.80 tc lt 3 front
set label 3 "Catch Up" rotate by -90
set label 3 at graph ((10000.0 + ${ATOMIC_SWITCH_MORPHUS_TASK}) / (${CATCHUP_MORPHUS_TASK} + 20000)), 0.80 tc lt 3 front
set label 5 "Finish" rotate by -90
set label 5 at graph ((10000.0 + ${CATCHUP_MORPHUS_TASK}) / (${CATCHUP_MORPHUS_TASK} + 20000)), 0.80 tc lt 3
#unset key
