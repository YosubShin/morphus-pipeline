...
if [ $# -lt 4 ]
then
    echo $"Usage: $0 --basedir=<base directory> --node_address=<hostname> --mode=<mode> --seed_address=<seed address>"
    exit 2
fi
...
echo "##(Re)Deploying Cassandra Node on $NODE_ADDRESS with mode $MODE"
